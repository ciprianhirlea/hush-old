        ...
        concat: {   
            dist: {
               files:{
                ...
                'js/min/main.js' : ['js/scripts.js','js/jquery.nivo.slider.js','js/jquery.fancybox.pack.js','js/jquery.fancybox.pack.js','js/jquery.carouFredSel.js' ,'js/jquery.placeholder-1.0.1.js','js/gf.placeholders.js']
               }
            }           
        },
