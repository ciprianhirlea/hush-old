			    ...
			    <div class="twitter-top"></div>
					...
					<div class="tweet">
						...
						<p>
					        	...
					        	<?php 
									$trunc = substr($t['text'],0,120);
									echo $trunc . "&hellip;"
					        	?>"</p>
					            <br/>

								<!-- Hide the time of tweets for now -->
								...
								<div class="intent-meta">
									...
									<span class="read-more"><a class="twitter-read-more-link" href="https://twitter.com/hushaesthetics">Read more on Twitter</a></span>
